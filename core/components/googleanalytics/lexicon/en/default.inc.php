<?php
	...
	$_lang['setting_googleanalytics_token']					= 'Session token';
	$_lang['setting_googleanalytics_token_desc']			= 'The Google Analytics session token that allows MODx to access Google Analytics.';
	$_lang['setting_googleanalytics_profile']				= 'Site profile';
	$_lang['setting_googleanalytics_profile_desc']			= 'The selected site profile where your Google Analytics data to be retrieved.';
	...
	$_lang['googleanalytics.visits_on']						= 'visits on';
	$_lang['googleanalytics.new_visits']					= 'New visits';
	$_lang['googleanalytics.pageviews']						= 'Pageviews';
	$_lang['googleanalytics.pageviews_on']					= 'Pageviews on';
	...
	$_lang['googleanalytics.settings_reset']				= 'Reset Google Analytics access';
		$_lang['googleanalytics.settings_reset_confirm']	= 'Are you sure you want to reset the Google Analytics acces?';
	$_lang['googleanalytics.settings_saved']				= 'Google Analytics settings saved.';
	$_lang['googleanalytics.auth_link']						= 'Click here to provide access to Google Analytics.';
	$_lang['googleanalytics.auth_desc']						= 'Currently MODx has no access to your Google Analytics account.';
	$_lang['googleanalytics.sources']						= 'Trafficsources';
	$_lang['googleanalytics.sources_traffic']				= 'Trafficsources';
	$_lang['googleanalytics.sources_devices']				= 'Operatingsystem';
	$_lang['googleanalytics.sources_mobile']				= 'Mobile vs Desktop';
	$_lang['googleanalytics.sources_source']				= 'Trafficsource';
	$_lang['googleanalytics.sources_searchengine']			= 'Searchengine';
	$_lang['googleanalytics.sources_direct']				= 'Direct traffic';
	$_lang['googleanalytics.sources_reference']				= 'Referring trafic';
	$_lang['googleanalytics.sources_mobile']				= 'Mobile';
	$_lang['googleanalytics.sources_desktop']				= 'Desktop';
	$_lang['googleanalytics.content']						= 'Popular pages';
	$_lang['googleanalytics.content_high']					= 'Important entrancepages';
	$_lang['googleanalytics.content_low']					= 'Important exitpages';
	$_lang['googleanalytics.content_source']				= 'Trafficsource';
	$_lang['googleanalytics.content_entrances']				= 'Entrancepoints';
	$_lang['googleanalytics.content_exit']					= 'Exitpoint';
	$_lang['googleanalytics.content_exitrate']				= 'Exitrate';
	$_lang['googleanalytics.search']						= 'Searchquery';
	$_lang['googleanalytics.search_global']					= 'Searchqueries';
	$_lang['googleanalytics.search_site']					= 'Searchqueries site';
